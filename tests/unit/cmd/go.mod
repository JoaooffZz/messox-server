...
require (
	...
	test/db v0.0.0-00010101000000-000000000000
)

require (
	db/models v0.0.0-00010101000000-000000000000 // indirect
	...
	services/chat_id v0.0.0-00010101000000-000000000000 // indirect
)
